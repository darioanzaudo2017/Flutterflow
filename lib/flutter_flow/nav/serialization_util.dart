  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case TipoActividadRow:
            return TipoActividadRow(data);
          case ActividadesRow:
            return ActividadesRow(data);
          case ResumenActividadesRow:
            return ResumenActividadesRow(data);
          case VistaActividadesTipoActRow:
            return VistaActividadesTipoActRow(data);
          default:
            return null;
        }
